;; color-theme-wyx.el --- Copy theme based on zenburn.el
...
;;      (gnus-cite-5 ((t (:foreground ,zenburn-red-3))))
	 ...
	 '(font-latex-math-face ((((class color) (background light)) (:foreground "SkyBlue1"))))
	 '(font-latex-sectioning-5-face ((((class color) (background light)) (:inherit variable-pitch :foreground "yellow" :weight bold))))
