...
twitter-password are set."
  (when (and twitter-username twitter-password)
    (let ((server-cons
           (or (assoc "iamzellux.com/twip" url-http-real-basic-auth-storage)
               (car (push (cons "iamzellux.com/twip" nil)
