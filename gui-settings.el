       ...
       (if (>= (x-display-pixel-height) 1440)
           (progn
             ...
             (set-fontset-font (frame-parameter nil 'font)
                               'han (font-spec :family "STHeiti" :size 15))
             (set-fontset-font (frame-parameter nil 'font)
                               'symbol (font-spec :family "STHeiti" :size 15))
             (set-fontset-font (frame-parameter nil 'font)
                               'cjk-misc (font-spec :family "STHeiti" :size 15))
             (set-fontset-font (frame-parameter nil 'font)
                               'bopomofo (font-spec :family "STHeiti" :size 15))
